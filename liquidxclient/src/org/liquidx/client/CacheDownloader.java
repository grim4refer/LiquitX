...
public class CacheDownloader {
	...
	private static final String CACHE_FILE_NAME = "LiquidXCache.zip"; //The name of the actual .zip file
	private static final String CACHE_URL = "https://www.dropbox.com/s/robfoy9m3w1sz8d/LiquidXCache.zip?dl=0";//+CACHE_FILE_NAME; //The url to the .zip file
	private static final String NEWEST_VERSION_FILE_URL = "https://www.dropbox.com/s/vmu7htoqtow34tx/cache_version.txt"; //The url to the current cache_versiont txt file
	private static final String CURRENT_VERSION_FILE = "cache_version.txt"; //The location of the local cache_version txt file

	public static final String URL_TO_LOADING_IMAGES = "http://liquidx.org/downloads/images/";
	public static final String MIRROR_URL_TO_LOADING_IMAGES = "http://liquidx.org/downloads/images/"; //If first link is broken, it will attempt to download from here
