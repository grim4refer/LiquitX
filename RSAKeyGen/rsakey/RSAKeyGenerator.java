...
public class RSAKeyGenerator {
	 ...
	 */
	private static String privateFile = "C:/RSPS/Necrotic/RSAPrivateKeys.txt";

	/**
	 * The location of the file which will contain the public key.
	 */
	private static String publicFile = "C:/RSPS/Necrotic/RSAPublicKeys.txt";
	...
	public static void main(String []args) {
		try {
			...
			System.out.println("RSAPrivateKeys.txt: "+privateFile);
			System.out.println("RSAPublicKeys: "+publicFile);
