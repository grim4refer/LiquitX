...
public class Configuration {
	...
	/** MAIN CONSTANTS **/
	public final static String CLIENT_NAME = "LiquidX";
	public final static int CLIENT_VERSION = 55;
	public final static String CACHE_DIRECTORY_NAME = "LiquidXCache"; //Cache folder name
	public static final String SETTINGS_DIRECTORY_NAME = "LiquidXSettings";
	...
	public final static String SERVER_HOST() {
		// return "world1.liquidx.org"; // your live server's IP
