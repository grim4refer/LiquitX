package org.liquidx.client.cache.definition;

import java.io.File;
import java.io.FileOutputStream;

import org.liquidx.client.Client;
import org.liquidx.client.List;
...
public final class ItemDefinition {
	...
	public static ItemDefinition get(int id) {
		...
		case 94430:
			...
			itemDef.maleWearId = 94371;
			itemDef.femaleWearId = 94371;
			break;
		...
		case 19906:
			...
			itemDef.maleWearId = 94487;
			itemDef.femaleWearId = 94487;
			break;
		case 12899:
		...
		case 14020:
			...
			itemDef.description = "A hood worn by LiquidX's veterans.".getBytes();
			itemDef.modelZoom = 760;
		...
		case 14021:
			...
			itemDef.description = "A cape worn by LiquidX's veterans.".getBytes();
			itemDef.modelZoom = 760;
			itemDef.modelOffset1 = 0;
			itemDef.modelOffsetY = 24;
			itemDef.modelRotation1 = 279;
