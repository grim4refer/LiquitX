package org.liquidx.client.world;

import org.liquidx.Configuration;
import org.liquidx.client.Class21;
import org.liquidx.client.Class33;
import org.liquidx.client.Client;
import org.liquidx.client.FrameReader;
import org.liquidx.client.SkinList;
import org.liquidx.client.cache.ondemand.OnDemandFetcherParent;
...
public class Model extends Animable {
	...
	public static void method459(int i, OnDemandFetcherParent onDemandFetcherParent) {
		aClass21Array1661 = new Class21[180000];
		newmodel = new boolean[180000];
	...
	public void setTexture(int tex,int color1, int colo2) {
		anInt1642 = anInt1630;
		int set2 = 0;
		...
		for(int i = 0; i < anInt1630; ++i) {
			if(anIntArray1640[i] >= color1 && anIntArray1640[i] <= colo2) {

				anIntArray1640[i] = tex;
				anIntArray1637[i] = 3 + set2;
				set2 += 4;
			} else {
				anIntArray1640[i] = anIntArray1640[i];
