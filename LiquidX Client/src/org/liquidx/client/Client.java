...
import org.liquidx.Configuration;
import org.liquidx.client.Settings.Load;
import org.liquidx.client.Settings.Save;
import org.liquidx.client.accounts.Account;
import org.liquidx.client.accounts.AccountManager;
import org.liquidx.client.cache.Archive;
import org.liquidx.client.cache.definition.Animation;
import org.liquidx.client.cache.definition.Flo;
import org.liquidx.client.cache.definition.IdentityKit;
import org.liquidx.client.cache.definition.ItemDefinition;
import org.liquidx.client.cache.definition.MobDefinition;
import org.liquidx.client.cache.definition.ObjectDefinition;
import org.liquidx.client.cache.definition.OverLayFlo317;
import org.liquidx.client.cache.definition.SpotAnimDefinition;
import org.liquidx.client.cache.definition.VarBit;
import org.liquidx.client.cache.definition.Varp;
import org.liquidx.client.cache.node.Deque;
import org.liquidx.client.cache.node.Node;
import org.liquidx.client.cache.ondemand.OnDemandFetcher;
import org.liquidx.client.cache.ondemand.OnDemandRequest;
import org.liquidx.client.constants.GameFrameConstants;
import org.liquidx.client.constants.GameFrameConstants.GameFrameType;
import org.liquidx.client.constants.SizeConstants;
import org.liquidx.client.entity.player.Player;
import org.liquidx.client.entity.player.PlayerHandler;
import org.liquidx.client.graphics.Background;
import org.liquidx.client.graphics.CursorData;
import org.liquidx.client.graphics.DrawingArea;
import org.liquidx.client.graphics.RSImageProducer;
import org.liquidx.client.graphics.Sprite;
import org.liquidx.client.graphics.SpriteLoader;
import org.liquidx.client.graphics.fonts.Censor;
import org.liquidx.client.graphics.fonts.RSFontSystem;
import org.liquidx.client.graphics.fonts.TextClass;
import org.liquidx.client.graphics.fonts.TextDrawingArea;
import org.liquidx.client.graphics.fonts.TextInput;
import org.liquidx.client.graphics.gameframe.GameFrame;
import org.liquidx.client.graphics.gameframe.GameFrame.ScreenMode;
import org.liquidx.client.graphics.gameframe.impl.ChatArea;
import org.liquidx.client.graphics.gameframe.impl.MapArea;
import org.liquidx.client.graphics.gameframe.impl.TabArea;
import org.liquidx.client.graphics.rsinterface.CustomMinimapIcon;
import org.liquidx.client.graphics.rsinterface.DamageDealer;
import org.liquidx.client.graphics.rsinterface.GrandExchange;
import org.liquidx.client.graphics.rsinterface.MagicInterfaceData;
import org.liquidx.client.graphics.rsinterface.PetSystem;
import org.liquidx.client.io.ByteBuffer;
import org.liquidx.client.io.ISAACCipher;
import org.liquidx.client.net.Connection;
import org.liquidx.client.net.HttpDownloadUtility;
import org.liquidx.client.renderable.Animable;
import org.liquidx.client.renderable.Animable_Sub3;
import org.liquidx.client.renderable.Animable_Sub5;
import org.liquidx.client.renderable.Entity;
import org.liquidx.client.renderable.Item;
import org.liquidx.client.renderable.NPC;
import org.liquidx.client.renderable.PlayerProjectile;
import org.liquidx.client.tools.FileUtilities;
import org.liquidx.client.world.CollisionMap;
import org.liquidx.client.world.CustomObjects;
import org.liquidx.client.world.Model;
import org.liquidx.client.world.Object1;
import org.liquidx.client.world.Object2;
import org.liquidx.client.world.Object3;
import org.liquidx.client.world.Object5;
import org.liquidx.client.world.ObjectManager;
import org.liquidx.client.world.Rasterizer;
import org.liquidx.client.world.Texture;
import org.liquidx.client.world.WorldController;
import org.liquidx.client.world.background.ScriptManager;
import org.liquidx.client.world.music.Class56;
import org.liquidx.client.world.music.Class56_Sub1_Sub1;
import org.liquidx.client.world.sound.Class25;
import org.liquidx.client.world.sound.Class3_Sub7;
import org.liquidx.client.world.sound.Class3_Sub7_Sub1;
import org.liquidx.client.world.sound.Class3_Sub7_Sub2;
import org.liquidx.client.world.sound.Class3_Sub9_Sub1;
import org.liquidx.client.world.sound.Class5;
import org.liquidx.client.world.sound.Class5_Sub1;
import org.liquidx.client.world.sound.Class5_Sub2;
import org.liquidx.client.world.sound.Class5_Sub2_Sub1;
import org.liquidx.client.world.sound.Class5_Sub2_Sub2;
import org.liquidx.client.world.sound.Sound;
import org.liquidx.client.world.sound.Sounds;
...
**/
	...
	private void method37(int j) {
		...
		if (Rasterizer.anIntArray1480[70] >= j) {
			Background background_1 = Rasterizer.aBackgroundArray1474s[70];
			int l = background_1.imgWidth * background_1.imgHeight - 1;
			int k1 = background_1.imgWidth * anInt945 * 2;
			byte abyte1[] = background_1.imgPixels;
			byte abyte4[] = aByteArray912;
		...
		if (Rasterizer.anIntArray1480[57] >= j) {
			Background background_1 = Rasterizer.aBackgroundArray1474s[57];
			int l = background_1.imgWidth * background_1.imgHeight - 1;
			int k1 = background_1.imgWidth * anInt945 * 2;
			byte abyte1[] = background_1.imgPixels;
			byte abyte4[] = aByteArray912;
	...
	public boolean handleRejection(int loginCode, String username, boolean reconnecting, Client client, String password) throws IOException {
		...
		if (loginCode == 4) {
			...
			loginMessage2 = "Appeal on www.liquidx.org";
			return false;
		}
		if (loginCode == 5) {
	...
	public void preloadModels() {
		...
		for (int i = 0; i < afile.length; i++) {
			...
			byte abyte0[] = ReadFile(Signlink.getCacheDirectory() + "/raw/" + s);
