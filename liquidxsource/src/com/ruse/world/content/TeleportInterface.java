...
public class TeleportInterface {
	...
	public static void resetInterface(Player player) {
		...
		player.getPacketSender().sendString(TITLE, "LiquidX Teleports");
	...
	public static enum TeleportInterfaceData {
		...
		YAKS(PAGEOPTIONS[1]+2, "Voldemort", "Level: 22", "@gre@Non-wilderness.", TeleportLocations.MAGEGREY, PAGEBUTTONS[1]+2),
		...
		CHAOS_DRUIDS(PAGEOPTIONS[1]+5, "Groudon", "The mythical pokemon Groudon", "@gre@Non-wilderness.", TeleportLocations.GROUDON2, PAGEBUTTONS[1]+5),
...
//		/* Dungeons */
		HEROESCAVE(PAGEOPTIONS[2], "Heroes Cave", "A low level dungeon.", "Holds a few slayer assignments.", TeleportLocations.HEROESCAVE, PAGEBUTTONS[2]),
		...
		BRIMHAVEN_DUNG(PAGEOPTIONS[2]+2, "Elemental Groudon cave", "A cave with elemental Groudons.", "", TeleportLocations.GROUDON, PAGEBUTTONS[2]+2),
		TAVERLY_DUNG(PAGEOPTIONS[2]+3, "Coming Soon", "A low to medium level dungeon.", "Has a few slayer tasks.", TeleportLocations.SLAYER_TOWER, PAGEBUTTONS[2]+3),
		GODWARS_DUNG(PAGEOPTIONS[2]+4, "Coming Soon", "A high level dungeon.", "Full of godly incarnations.", TeleportLocations.SLAYER_TOWER, PAGEBUTTONS[2]+4),
		STRYKEWYRM_CAVERN(PAGEOPTIONS[2]+5, "Coming Soon", "A high level dungeon.", "Only contains strykewyrms.", TeleportLocations.SLAYER_TOWER, PAGEBUTTONS[2]+5),
//		/* Bosses */
		GODWARS(PAGEOPTIONS[3], "Coming Soon", "Home to each god's champion.", "Lots of unique drops available.", TeleportLocations.GWD, PAGEBUTTONS[3]),
		DAGANNOTH_KINGS(PAGEOPTIONS[3]+1, "Coming Soon", "The Dagannoth lair, containing the kings.", "Medium to high level content.", TeleportLocations.DAGKINGS, PAGEBUTTONS[3]+1),
		FROST_DRAGONS(PAGEOPTIONS[3]+2, "Coming Soon", "Popular for their frostdragon bones.", "@red@Warning: Level 46 Wilderness!", TeleportLocations.FROSTDRAGONSWILDY, PAGEBUTTONS[3]+2),
		TORMENTED_DEMONS(PAGEOPTIONS[3]+3, "Coming Soon", "Have a chance to drop Dragon claws.", "Also have a chance to kill you.", TeleportLocations.TORMENTEDDEMONS, PAGEBUTTONS[3]+3),
		KING_BLACK_DRAGON(PAGEOPTIONS[3]+4, "Coming Soon", "The King of black dragons.", "@gre@Non-wilderness.", TeleportLocations.KBD, PAGEBUTTONS[3]+4),
		CHAOS_ELEMENTAL(PAGEOPTIONS[3]+5, "Coming Soon", "An unnerving entity.", "@red@Warning: Level 50 Wilderness!", TeleportLocations.CHAOSELE, PAGEBUTTONS[3]+5),
		SLASHBASH(PAGEOPTIONS[3]+6, "Coming Soon", "An angry ogre in his cave.", "His flesh is rotting off!", TeleportLocations.SLASHBASH, PAGEBUTTONS[3]+6),
		KALPHITE_QUEEN(PAGEOPTIONS[3]+7, "Coming Soon Queen", "Queen of the Kalphites.", "This boss has multiple forms!", TeleportLocations.KQ, PAGEBUTTONS[3]+7),
		PHOENIX(PAGEOPTIONS[3]+8, "Coming Soon", "The flying infero.", "Beatiful and deadly.", TeleportLocations.PHOENIX, PAGEBUTTONS[3]+8),
		BANDOS_AVATAR(PAGEOPTIONS[3]+9, "Coming Soon", "A avatar created by the power of Bandos.", "Incredibly lethal.", TeleportLocations.BANDOSAVATAR, PAGEBUTTONS[3]+9),
		GLACORS(PAGEOPTIONS[3]+10, "Coming Soon", "Frozen shells of their former selves.", "Coveted for their boot drops.", TeleportLocations.GLACORS, PAGEBUTTONS[3]+10),
		CORPERAL_BEAST(PAGEOPTIONS[3]+11, "Coming Soon", "Guardian of the spirit shields.", "Very strong, be careful!", TeleportLocations.CORPBEAST, PAGEBUTTONS[3]+11),
		NEX(PAGEOPTIONS[3]+12, "Coming Soon", "An ancient creature and Zarosian.", "Drops ancient armor.", TeleportLocations.NEX, PAGEBUTTONS[3]+12),
		CALLISTO(PAGEOPTIONS[3]+13, "Coming Soon", "A chaotic bear.", "@red@Warning: Level 35 Wilderness.", TeleportLocations.CALLISTO, PAGEBUTTONS[3]+13),
		VET_ION(PAGEOPTIONS[3]+14, "Coming Soon", "An old, demented soul.", "@red@Warning: Level 31 Wilderness.", TeleportLocations.VETION, PAGEBUTTONS[3]+14),
		VENENATIS(PAGEOPTIONS[3]+15, "Coming Soon", "A terrible spider.", "Warning: Level 27 Wilderness.", TeleportLocations.VENENATIS, PAGEBUTTONS[3]+15),
		ZULRAH(PAGEOPTIONS[3]+16, "Coming Soon", "Our custom take on Zulrah. Be careful!", "Keep items on death.", TeleportLocations.ZULRAH, PAGEBUTTONS[3]+16),
		KRAKEN(PAGEOPTIONS[3]+17, "Coming Soon", "A monster of the sea.", "@gre@Non-wilderness.", TeleportLocations.KRAKEN, PAGEBUTTONS[3]+17),
		SCORPIA(PAGEOPTIONS[3]+18, "Coming Soon", "Queen of the scorpions.", "@gre@Non-wilderness.", TeleportLocations.SCORPIA, PAGEBUTTONS[3]+18),
		/* Minigames */
