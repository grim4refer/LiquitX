...
public class messageSpammerTimer {
	...
	public static void massMessageHandler() {
		...
		String[] messages = { 
				// h'ween "@or1@Happy Halloween from LiquidX! Pumpkins & Scythes drop this weekend!",
				// xmas "@red@Merry @gre@Christmas <col=FF0077>from LiquidX! Help Santa via the Snomwan at home.",
				...
				"Check our forums to stay up to date on everything LiquidX!",
				...
				"Have questions? Ask in the clanchat \"LiquidX!\"",
